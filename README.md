...
| Service | URL | Status |
| :--- | :--- | :--- |
| **Main Portal** | **[hoid.app](https://hoid.app)** | 🟢 Live |
| **Research Lab** | [thehumanoid.tech](https://thehumanoid.tech) | 🟢 Live |

---

### 🛠️ Roadmap
- [x] **Core Identity**: Brand & Domain Asset Secured.
- [ ] **Alpha Launch**: Initial release of the Hoid mobile interface.
- [ ] **Agent Integration**: On-device LLM capabilities.
